...
// in krono/test/src/features/journal/presentation/add_entry_screen_test.dart.
...
import 'package:krono/src/core/database/database.dart' as _i3;
import 'package:krono/src/core/utils/weather_service.dart' as _i6;
import 'package:krono/src/features/journal/data/journal_repository.dart' as _i7;
...
class _Fake$DayEntriesTable_2 extends _i1.SmartFake
    implements _i3.$DayEntriesTable {
  _Fake$DayEntriesTable_2(
    Object parent,
    Invocation parentInvocation,
  ) : super(
          parent,
...
class _Fake$StreakAdjustmentsTable_3 extends _i1.SmartFake
    implements _i3.$StreakAdjustmentsTable {
  _Fake$StreakAdjustmentsTable_3(
    Object parent,
    Invocation parentInvocation,
  ) : super(
          parent,
...
class _Fake$ActivityLogTable_4 extends _i1.SmartFake
    implements _i3.$ActivityLogTable {
  _Fake$ActivityLogTable_4(
    Object parent,
    Invocation parentInvocation,
  ) : super(
          parent,
...
class _FakeWeatherData_23 extends _i1.SmartFake implements _i6.WeatherData {
  _FakeWeatherData_23(
    Object parent,
    Invocation parentInvocation,
  ) : super(
...
class MockJournalRepository extends _i1.Mock implements _i7.JournalRepository {
  ...
  @override
  _i5.Future<void> deleteEntry(_i8.JournalEntry? entry) => (super.noSuchMethod(
        Invocation.method(
          #deleteEntry,
          [entry],
        ),
  ...
  @override
  _i5.Future<List<_i8.JournalEntry>> getAllEntries() => (super.noSuchMethod(
        Invocation.method(
          #getAllEntries,
          [],
        ),
        returnValue:
            _i5.Future<List<_i8.JournalEntry>>.value(<_i8.JournalEntry>[]),
      ) as _i5.Future<List<_i8.JournalEntry>>);
...
class MockAppDatabase extends _i1.Mock implements _i3.AppDatabase {
  ...
  @override
  _i3.$DayEntriesTable get dayEntries => (super.noSuchMethod(
        Invocation.getter(#dayEntries),
        returnValue: _Fake$DayEntriesTable_2(
          this,
          Invocation.getter(#dayEntries),
        ),
      ) as _i3.$DayEntriesTable);

  @override
  _i3.$StreakAdjustmentsTable get streakAdjustments => (super.noSuchMethod(
        Invocation.getter(#streakAdjustments),
        returnValue: _Fake$StreakAdjustmentsTable_3(
          this,
          Invocation.getter(#streakAdjustments),
        ),
      ) as _i3.$StreakAdjustmentsTable);

  @override
  _i3.$ActivityLogTable get activityLog => (super.noSuchMethod(
        Invocation.getter(#activityLog),
        returnValue: _Fake$ActivityLogTable_4(
          this,
          Invocation.getter(#activityLog),
        ),
      ) as _i3.$ActivityLogTable);

  @override
  _i2.Index get idxDayEntriesDate => (super.noSuchMethod(
        Invocation.getter(#idxDayEntriesDate),
...
class MockWeatherService extends _i1.Mock implements _i6.WeatherService {
  ...
  @override
  _i5.Future<_i6.WeatherData> fetchWeather({
    required double? lat,
    required double? lon,
    ...
    _i10.Client? client,
      ...
      (super.noSuchMethod(
        ...
        returnValue: _i5.Future<_i6.WeatherData>.value(_FakeWeatherData_23(
          this,
          Invocation.method(
            #fetchWeather,
            [],
